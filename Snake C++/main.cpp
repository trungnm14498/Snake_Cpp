...
void thong_bao3()
{
	...
	if (game_over3())
	{
		...
		gotoXY(55, 14);
		if (kt_ran_cham_ran() == 1 || (toa_do_x[0] == 10 || toa_do_x[0] == 110 || toa_do_y[0] == 1 || toa_do_y[0] == 27))
			cout << "*** PLAYER 2 IS WINNER ***";
		else if (kt_ran_cham_ran() == 2|| (toa_do_x2[0] == 10 || toa_do_x2[0] == 110 || toa_do_y2[0] == 1 || toa_do_y2[0] == 27))
